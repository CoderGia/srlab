...
def preemphasis(signal, pre_emphasis=0.97):
    # Here you need to pre_emphasis input signal with pre_emphasis coeffitient

    """
    :param signal: input signal
    :param pre_emphasis: pre_emphasis coeffitient
...
def compute_fbank_filters(nfilt=40, sample_rate=16000, NFFT=512):
    ...
    ###########################################################
    # Here is your code to convert Hz to Mel:
    ...
    ###########################################################
    # Here is your code to convert Mel to Hz:
